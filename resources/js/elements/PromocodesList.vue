<template>
    <div class="flex flex-col gap-y-3">
        <div class="code-item bg-white py-4 px-5 flex gap-x-3 mx-1" v-for="code in codes">
            ...
            <div class="flex flex-col">
                ...
                <p class="font-semibold text-[#505050] lg:text-3xl">{{ code.title }}</p>
...
export default {
    ...
    methods: {
        ...
        parseDate(date) {
            ...
            let result;
            if(date) {
                result = dt.toLocaleDateString("ru", { day: 'numeric', month: 'long', year: 'numeric' })
