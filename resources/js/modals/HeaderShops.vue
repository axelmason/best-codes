<template>
    <div class="shops-wrapper" @mouseenter="open=true" @mouseleave="open=false">
        <span class="font-roboto font-bold text-white hover:cursor-pointer flex">Все магазины <img class="ml-1 transition-transform" :class="{'rotate-180': open}" src="/arrow_down.svg" alt=""></span>
